                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form className="space-y-4 md:space-y-6" action="#">
                                ...
                                <div>
                                    ...
                                    <input type="confirm-password" name="confirm-password" id="confirm-password" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-red-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required />
                                </div>
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3 text-sm">
                                        <label htmlFor="terms" className="font-light text-red-900">I accept the <a className="font-medium text-primary-600 hover:underline" href="#">Terms and Conditions</a></label>
                                    </div>
                                </div>
                                ...
                                <p className="text-sm font-light text-red-900">
                                    Already have an account? <a href="/signin/" className="font-medium text-primary-600 hover:underline">Signin here</a>
                                </p>
                                <p className="text-sm">
                                    <a href="/" className="font-medium text-red-900 hover:underline">Back to home</a>
                                </p>
                            </form>
                        </div>
                    </div>
