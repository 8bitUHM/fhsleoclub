        ...
        <>
            <nav className="bg-red-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse order-1">
                    ...
                    <div className="flex items-center pt-1 order-2 md:order-last space-x-0 md:space-x-3">
                        ...
                        <div className="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
                            <div className="px-4 py-3">
                                <span className="block text-sm text-gray-900 dark:text-white">Maximilien Featherstone</span>
                                <span className="block text-sm  text-gray-500 truncate dark:text-gray-400">Maximilien_Featherstone_2023@farringtonhighschool.org</span>
                            </div>
