    ...
    return (
        <>
            <div className="h-[10rem] bg-red-900 flex justify-center items-center text-balance">
                <a href="https://www.instagram.com/farringtonhs_leo_club/" className="flex flex-row justify-center items-center">
                    <img src="/fhs-leo-club-logo.png" className="w-20 h-20 mx-3 self-center" alt="Leo Club Logo" />
                    <div className="flex flex-col">
                        <h2 className="text-white text-4xl md:text-5xl drop-shadow-lg font-family font-oswald font-medium py-3">Instagram @ farringtonhs_leo_club</h2>
